...
class TucanUrlTest {
    ...
    fun testCOURSEDETAILS() {
        ...
        assertEquals(TucanUrl.COURSEDETAILS(391343674191079, 393376110960575), TucanUrl.COURSEDETAILS.fromString("/scripts/mgrqispi.dll?APPNAME=CampusNet&PRGNAME=COURSEDETAILS&ARGUMENTS=-N161544538691882,-N000274,-N391343674191079,-N393376110963574,-N393376110960575,-N0,-N0"))
    }
