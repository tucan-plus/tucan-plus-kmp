...
class TucanUrlTest {
    ...
    fun testCOURSEDETAILS() {
        // exams
        assertEquals(TucanUrl.COURSEDETAILS(393376109436095, 393376109438096), TucanUrl.COURSEDETAILS.fromString("/scripts/mgrqispi.dll?APPNAME=CampusNet&PRGNAME=COURSEDETAILS&ARGUMENTS=-N916877825818552,-N000318,-N0,-N393376109436095,-N393376109438096,-N0,-N0,-N3,-AvWRKRfKCvNw5cNH7xgldONHQOz6mQfHIeULo3SfdCvNNef5CVYwSWgLKWoHZmIoIeUpQCfnAcgREmDofRqPVVzRfxqKYOMPzVfHhQqW9RoK-YIP8WzApmzetx-W73oRqfQPP7dyZeMoefInwHBGumu5CWWUsRQPBP-o04opuWf5mQglFvYobcDZ7fumv4UU5RgP8fS7NRvZPetNAfImmYUPuxNKMvI5QVun6x-7AcURKfBDjmDwDYWcAYfwemzH7HYwbxdRC3uHhxjndcNKeOZKzeWK9rgLEVMRSHSRzvSLDejRovW59QDmKxDwXQjAd3YoM7fKy7ZPpHIHmRSLE4gHZPqUXHYmmVMpKc-ozcvZq4Q5L4SAJxZppcUKVHjAWQgoPcDLXPqKQ4fKuxUHFHDRBcZWAx-5v7-mxmSP-CQin"))
        // my courses
        assertEquals(TucanUrl.COURSEDETAILS(393376110963574, 393376110960575), TucanUrl.COURSEDETAILS.fromString("/scripts/mgrqispi.dll?APPNAME=CampusNet&PRGNAME=COURSEDETAILS&ARGUMENTS=-N161544538691882,-N000274,-N391343674191079,-N393376110963574,-N393376110960575,-N0,-N0"))
    }

    @Test
    fun testMODULEDETAILS() {
        assertEquals(TucanUrl.MODULEDETAILS(387685295719338), TucanUrl.MODULEDETAILS.fromString("/scripts/mgrqispi.dll?APPNAME=CampusNet&PRGNAME=MODULEDETAILS&ARGUMENTS=-N852415230330934,-N000318,-N387685295719338,-ARjP6Vf68fDwBefmNPjHUWYw3e-p6OuRtfZKyQM5fHUn-OZUlYWKNrDwIxYZUYWmQfq5Mx-RwRdwoPILWfBKBWjWaxYAVxuHHYImKYBZUOd2ZvqPV3WeNczHKVZUyeqZh4S5xxfRxxSljWoPvcBATWupvRSUYxuLkPDA6mDmyQMHLQNW0RImM7dPbfDAK4UWDWfwyxjKJxU5gcuUlmBHbvNKBRYHyfYmhWMU9xdK6QoWfOfw7mgPyWoWHe-HJHfG-PWokmu5seuWVmIUMmIV9H-WlYIHtVgRKOdKSmup-mZKlWIRkYIpSczRBHjUQmSWgmgn-VQB6vzVA4qoQWooqOgppHBmo7NPBHgoV7-mExU7wRoouedn9RMLDOWUbf-DFxjV6mBGCRfwsQzKSONK3VMAIQfRuQDHzxSK-YzozvD2n"))
    }
