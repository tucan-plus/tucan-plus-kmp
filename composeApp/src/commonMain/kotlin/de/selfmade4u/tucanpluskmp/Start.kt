        ...
        Column(modifier = Modifier.padding(innerPadding)) {
            if (value != null) {
                ...
                Button(
                    ...
                    onClick = {
                        coroutineScope.launch {
                            backStack[backStack.size - 1] = LoginNavKey("http://localhost:8080/IdentityServer/connect/authorize?client_id=MobileApp&scope=openid+DSF+profile+offline_access&response_mode=query&response_type=code&ui_locales=de&redirect_uri=de.datenlotsen.campusnet.tuda:/oauth2redirect")
                        }
